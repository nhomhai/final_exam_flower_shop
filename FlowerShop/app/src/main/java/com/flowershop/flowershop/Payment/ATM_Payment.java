...
public class ATM_Payment extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.atm_payment2);
    ...
    {
        EditText name = (EditText) findViewById(R.id.editText_rname_atm);
        EditText address = (EditText) findViewById(R.id.editText_raddress_atm);
        EditText phone = (EditText) findViewById(R.id.editText_rphone_atm);
        ...
        Intent goback = new Intent(ATM_Payment.this,login_view_flower.class);
